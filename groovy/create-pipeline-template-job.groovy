...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/jarchercb-ci-demo/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>jarchercb-ci-demo</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>jarchercb-ci-demo</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/jarchercb-ci-demo/pipeline-template-catalog.git</repositoryUrl>
              <traits>
